...
$lang = array_merge($lang, array(
	...
	'COOKIE_SECURE_EXPLAIN'			=> 'Si votre serveur fonctionne par l’intermédiaire du protocole SSL, Mettez cette option sur « OUI » sinon laissez sur « NON ». Si vous activez cette option alors que votre serveur n’est pas sous le protocole SSL, des erreurs se produiront lors des redirections.',
	...
	'NO'					=> 'Non',
	'NO_ALT_ENV'			=> 'Aucun environnement alternatif trouvé.',
	...
	'QI_MANAGE_ABOUT'		=> 'Installer un nouveau forum ici.<br /><br />"Base de données du forum et nom de répertoire :" est le seul champ que vous devez remplir, les autres se remplissent avec des valeurs par défaut à partir de "includes/default_settings.php".<br /><br />Cliquez sur « Options avancées » pour plus de paramètres.',
