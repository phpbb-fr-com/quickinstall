...
* @version $Id:	papicx	1.1.8	14/01/2013 09h42 $
...
$lang = array_merge($lang, array(
	...
	'CONFIG_SETTINGS'				=> 'Paramètres de configuration du site',
	'CONFIG_SETTINGS_EXPLAIN'		=> 'Les réglages effectués ici sont des paramètres généraux pour votre forum phpBB. Ceux-ci peuvent également être définis lorsque de nouveaux forums sont créés.',
	'CONFIG_WARNING'				=> 'Cliquez sur ce bouton pour voir la configuration. <b>Attention:</b> Les mots de passe inscrits seront affichés.',
	'CONVENIENCE'					=> 'Boutton Sauvegarder/Réinitialiser',
	'CONVENIENCE_EXPLAIN'			=> 'Ces boutons sont là pour votre commodité (et la mienne). Ils sont identiques aux autres boutons Sauvegarder/Réinitialiser et sauvegardent/réinitialisent l’intégralité du formulaire.',
	...
	'POPULATE_EXPLAIN'		=> 'Permet de créer automatiquement des utilisateurs, des catégories, des forums, des sujets et des messages selon les paramètres spécifiés ci-dessous. Plus ces valeurs sont élevées, plus le temps de création du forum sera important.<br />Tous ces réglages peuvent être modifiés lorsque vous créez un forum.',
	...
	'QI_MAIN'				=> 'Installer les forums',
	'QI_MAIN_ABOUT'			=> 'Installez ici un nouveau forum.<br /><br />« Nom du répertoire et de la base de données du forum » est le seul champ que vous devez remplir, les autres seront remplis en utilisant les valeurs par défaut contenues dans <em>includes/default_settings.php</em>.<br /><br />Cliquez sur « Options avancées » afin d’obtenir davantage de réglages.',
	...
	'THESE_CAN_CHANGE'		=> 'Ces réglages peuvent être modifiés lors de la création d’un forum.',
